...
@Log4j2
@Service
@Validated // Les annotations de validation sont actives sur les méthodes de ce service (ex: @Positive)
public class BankService {
	...
	public void transferMoney(int fromId, int toId, 
		...
		if (fromId == toId) {
			throw new IllegalArgumentException("Impossible de transférer à l'intérieur d'un même compte");
		}
